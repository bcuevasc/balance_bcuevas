// ==========================================================
// 🧠 BÚNKER SCADA - MOTOR LÓGICO V31.9.5 (NÚCLEO HÍBRIDO + LOGOS + ZOOM)
// ==========================================================
...
function renderizarListas(sueldoBase, filtroBuscador) {
    ...
    datos.forEach(x => {
        ...
        if (contenedorMovil) {
            // Compatibilidad con Bottom Sheet o edición directa
...
window.hacerZoomGrafico = function(diaIn, diaFin) {
    ...
    // Mutamos los datos del gráfico cortando la matriz maestra
    ...
    // Al redibujar, el eje X y el eje Y se reajustarán automáticamente
    chartBD.update();
};
